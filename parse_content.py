...
effects = {
    ...
    'BiodiversityPressureForFeature':    lambda e: ('ProcessFeature::{}'.format(e['subtype']), param(e, 'Change')),
...
effect_keys = {
  ...
  'BiodiversityPressureForFeature': ['subtype', 'params'],
  ...
  'ModifyProcessByproducts': ['entity', 'subtype', 'params'],
