...
impl FontLoader for egui::FontDefinitions {
    fn load_font(&mut self, name: &str, font: &'static [u8]) {
        ...
        self.font_data.insert(name.to_string(), font_data.into());
...
fn load_fonts() -> egui::FontDefinitions {
    ...
    fonts.load_font("W95FA", include_bytes!("../assets/fonts/W95FA/W95FA.otf"));
    fonts.load_font(
        "Inter",
    ...
    fonts.load_font(
        "TimesTen-Italic",
        include_bytes!("../assets/fonts/TimesTen/TimesTen-Italic.ttf"),
    );
    fonts.load_font(
        "NotoSansThai",
    ...
    fonts.load_font(
        "NotoSansJP",
        include_bytes!("../assets/fonts/NotoSansJP-Regular.subset.ttf"),
    );
...
pub fn configure_style(ctx: &egui::Context) {
    ...
    let style = egui::Style {
        text_styles: [
            (TextStyle::Heading, FontId::new(24.0, family("TimesTen"))),
    ...
    visuals.selection.bg_fill = Color32::from_rgb(0xfc, 0xba, 0x03);
    visuals.selection.stroke = egui::Stroke::new(1., egui::Color32::BLACK);
    visuals.widgets.hovered.weak_bg_fill = egui::Color32::from_gray(20);
    visuals.widgets.hovered.bg_stroke = egui::Stroke::new(0.5, egui::Color32::from_gray(64));
    visuals.widgets.open.weak_bg_fill = egui::Color32::from_gray(24);
    visuals.widgets.open.bg_fill = egui::Color32::from_gray(24);
    visuals.widgets.inactive.weak_bg_fill = egui::Color32::from_gray(24);
