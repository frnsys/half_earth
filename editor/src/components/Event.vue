...
<li class="event">
  <div>
    ...
    <textarea class="event--body" v-model="localEvent.body" @blur="save" placeholder="Event description" />
  </div>
  <fieldset>
    <div>
      <label>
  ...
  <div>
    ...
    <textarea v-model="localEvent.description" placeholder="Variations on the event" @blur="save" />
  </div>
  <fieldset>
